...
export function ProductStoryPage({ dashboardHref, productsHref }: ProductStoryPageProps) {
  ...
  return (
    <div className="space-y-6 pb-20 px-3 md:px-6 text-left max-w-7xl mx-auto">
      <PageHeader
        items={[
      ...
      {!product ? (
        <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
          ...
          <p className="text-sm text-gray-500 mt-2">The requested product details could not be loaded.</p>
        </div>
      ) : (
        <div className="space-y-12">
          {/* Header Section */}
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.4fr] gap-6 md:gap-10">
            <div className="rounded-3xl border border-gray-100 bg-white p-5 md:p-10 shadow-sm flex flex-col md:flex-row gap-8 md:gap-12">
              ...
              <div className="flex-1 flex flex-col justify-center py-2">
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-4">
                    <Button className="flex-1 md:flex-none bg-[#1d3d1e] hover:bg-black text-white px-8 h-12 gap-2 font-black uppercase tracking-widest text-[10px] shadow-xl shadow-brand/10 rounded-xl">
                    ...
                    <Button variant="outline" className="w-full md:w-auto h-12 px-8 border-gray-200 text-gray-700 hover:bg-gray-50 font-black uppercase tracking-widest text-[10px] gap-2 rounded-xl">
