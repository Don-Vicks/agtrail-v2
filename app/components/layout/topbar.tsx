...
export function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 w-full items-center justify-between gap-4 border-b border-gray-200 bg-white px-4 md:px-6">
      ...
      <div className="flex shrink-0 items-center gap-2 md:gap-3">
        {/* Tabs */}
        <div className="hidden md:flex items-center gap-1 rounded-lg border border-gray-200 p-0.5">
