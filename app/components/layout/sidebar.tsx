        ...
        {items.map((item) => (
          <NavLink
            ...
            to={item.href}
              ...
              item.href === '/farmer' || item.href === '/farmer/certifications'
            }
            onClick={onItemClick}
            className={({ isActive }) =>
              cn(
    ...
    <>
      ...
      >
        ...
        <div className='flex-1 overflow-y-auto pb-4'>
          <NavGroup
            label='Platform'
            items={sidebarNavigation.platform}
            onItemClick={() => sidebarCtx?.closeMobile()}
          />
          <NavGroup
            label='Operations'
            items={sidebarNavigation.operations}
            onItemClick={() => sidebarCtx?.closeMobile()}
          />
          <NavGroup
            label='Certification'
            items={sidebarNavigation.certification}
            onItemClick={() => sidebarCtx?.closeMobile()}
          />
          <NavGroup
            label='Finance'
            items={sidebarNavigation.finance}
            onItemClick={() => sidebarCtx?.closeMobile()}
          />
          <NavGroup
            label='Reports'
            items={sidebarNavigation.reports}
            onItemClick={() => sidebarCtx?.closeMobile()}
          />
              ...
              <div className='space-y-2.5 px-0.5 text-[13px] font-medium'>
                {isLoadingWallet ? (
                  ...
                  <>
                    ...
                    {/* Keep AGT token for platform rewards context */}
                    <div className='flex justify-between items-center text-gray-600'>
                      <span>AGT</span>
                      <span className='font-mono text-gray-900 font-bold'>
                        0.00
