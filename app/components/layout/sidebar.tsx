        ...
        {items.map((item) => (
          <NavLink
            ...
            to={item.href}
              ...
              item.href === '/farmer' ||
              item.href === '/farmer/certifications'
            }
            onClick={onItemClick}
            className={({ isActive }) =>
              cn(
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[10px] text-gray-500 font-mono tracking-wide">{isLoadingWallet ? 'Loading...' : (walletAddress ? walletAddress.slice(0, 10) + '...' + walletAddress.slice(-4) : 'No Wallet Address')}</div>
            </div>
          </div>
          <svg
