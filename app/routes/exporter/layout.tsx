...
import { exporterSidebarNavigation } from '~/lib/mock-data/exporter'

function ExporterLayoutContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <Sidebar navigation={exporterSidebarNavigation} roleLabel="Exporter" />
...
export default function ExporterLayout() {
  return (
    <AuthGuard allowedRoles={['exporter', 'admin']}>
      <SidebarProvider>
        <ExporterLayoutContent />
      </SidebarProvider>
    </AuthGuard>
  )
}
