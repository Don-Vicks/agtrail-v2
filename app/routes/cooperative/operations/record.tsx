...
export default function RecordOperation() {
  ...
  const loadError =
    isFarmsError || isCyclesError
      ...
      'Could not load cooperative farms or crop cycles. Try again later.'
      : null
    ...
    <div className="space-y-6">
      ...
      {isLoadingCycles ? (
        ...
        <EmptyState
          ...
          description="There are no crop cycles matching your filters, or none exist yet for cooperative farms."
        />
      )}
