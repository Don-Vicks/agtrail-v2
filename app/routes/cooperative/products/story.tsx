  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      >
        ...
        <span className='font-extrabold text-[32px] text-gray-900 relative leading-none mb-0.5'>
          {score}
        </span>
        <span className='text-[10px] text-gray-400 font-bold uppercase tracking-wider relative'>
          Score
        </span>
      </div>
      <p className='text-xs text-gray-500 mt-2 flex items-center gap-1'>
        {label}{' '}
        <span className='inline-block size-3.5 rounded-full border border-gray-300 text-gray-400 text-[8px] flex items-center justify-center'>
          ?
        </span>
      </p>
    </div>
  ...
  return (
    <div className='rounded-xl border border-gray-100 bg-white p-5 shadow-sm'>
      <div className='flex items-center justify-between mb-3'>
        ...
        <span className='size-4 rounded-full border border-gray-300 text-gray-400 text-[8px] flex items-center justify-center'>
          ?
        </span>
      </div>
      <p className='text-2xl font-extrabold text-gray-900 mb-3'>
        {score} <span className='text-sm font-medium text-gray-500'>Score</span>
      </p>
  ...
  const people = [
    {
      ...
      description: 'Source farm details tracked via operations',
      role: 'Farmer',
      color: '#2E5A27',
    },
    {
      name: 'Fashola',
      operations:
        '4 operations: harvesting, fertilizing, planting, land_preparation',
    ...
    {
      name: 'Olamide',
      operations: '3 operations: harvesting, planting, land_preparation',
      date: 'February 13th, 2026',
      role: 'Supervisor',
      color: '#2E5A27',
    },
    {
      name: 'Fashola',
      operations: '1 operations: fertilizing',
      date: 'February 13th, 2026',
      role: 'Supervisor',
      color: '#2E5A27',
    },
  ...
  const certifications = [
    {
      ...
      expires: 'February 25th, 2026',
      status: 'Active',
    },
    {
      name: 'global_gap',
      date: 'February 11th, 2026',
      expires: 'February 24th, 2026',
      status: 'Active',
    },
    {
      name: 'food_safety',
    ...
    <div className='space-y-6'>
      <PageHeader
        items={[
          ...
          { label: 'Products', href: '/cooperative/products' },
      ...
      <div className='flex flex-col lg:flex-row gap-6'>
        ...
        <div className='flex-1 rounded-xl border border-gray-100 bg-white p-6 shadow-sm'>
          <div className='w-[200px] h-[200px] mx-auto sm:mx-0 rounded-lg border border-gray-200 bg-white mb-6 overflow-hidden'>
            <img
          ...
          <h1 className='text-[28px] font-extrabold text-[#2E5A27] mb-1 leading-none'>
            {product.name.toUpperCase()}
          </h1>
          <p className='text-xs text-gray-500 font-medium mb-4 tracking-wide'>
            {product.batchId}
          </p>
      ...
      <Tabs defaultValue='journey' className='w-full'>
        <div className='flex justify-center mb-6'>
          <TabsList className='h-11! bg-gray-100 border border-gray-200 p-1 rounded-lg grid grid-cols-4 w-full max-w-[500px] items-stretch'>
            <TabsTrigger
              value='journey'
              className='h-full px-3 text-[13px] font-semibold text-gray-500 data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-sm rounded-md transition-all'
            >
              Journey
            </TabsTrigger>
            <TabsTrigger
          ...
          <div className='max-w-3xl mx-auto space-y-6'>
            ...
            <div className='text-center mb-2'>
              ...
              <p className='text-sm text-gray-500'>
                Comprehensive sustainability evaluation across four key
                dimensions
              </p>
            </div>
            ...
            <div className='flex justify-center py-4'>
              <ScoreRing
                score={product.metrics.sustainabilityScore}
                size={180}
                label=''
              />
            </div>
            ...
            <p className='text-center text-xs text-gray-400 mb-4'>
              Weighted across Environmental (40%), Economic (25%), Social (25%),
              Governance (10%){' '}
              <span className='inline-block size-3.5 rounded-full border border-gray-300 text-[8px]'>
                ?
              </span>
            </p>
          ...
          <div className='max-w-3xl mx-auto space-y-6'>
            ...
            <div className='rounded-xl border border-gray-100 bg-white p-8 shadow-sm flex flex-col items-center text-center'>
              ...
              <p className='text-xs text-gray-500 mb-8'>
                Safety standards and regulatory compliance status
              </p>
              <div className='flex items-center justify-center gap-16 md:gap-24 mb-4'>
                <ScoreRing
                  score={product.metrics.qualityScore}
                  label='Quality Score'
                />
                <ScoreRing
                  score={product.metrics.complianceRate}
                  label='Compliance Rate'
                />
              </div>
              <p className='text-[11px] text-gray-400 mt-4'>
                Based on quality test results and certification status
              </p>
            </div>
                ...
                {product.tests.length > 0 ? (
                  <div className='space-y-3'>
                    {product.tests.map((test, i) => (
                      <div
                        key={i}
                        className='flex items-center justify-between p-4 rounded-lg border border-gray-100 bg-white hover:border-gray-200 transition-all'
                      >
                  ...
                  <div className='text-center py-8'>
                    ...
                    <p className='text-xs text-gray-400 mt-1'>
                      Quality tests will appear here once they are conducted
                    </p>
                  </div>
                )}
              </div>
        ...
        >
          <div className='max-w-3xl mx-auto space-y-6'>
            <div className='text-center mb-2'>
              ...
              <p className='text-sm text-gray-500'>
                Everyone who contributed to this product's journey
              </p>
            </div>
            ...
            <div className='space-y-3'>
              {people.map((person, i) => (
                <div
                  key={i}
                  className='rounded-xl border border-gray-200 bg-white p-5 shadow-sm flex items-start gap-4'
                >
                  <div
                    className='size-10 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0'
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    {person.farm && (
                      <p className='text-xs text-gray-500'>{person.farm}</p>
                    )}
                    {person.description && (
                      <p className='text-xs text-gray-400'>
                        {person.description}
            ...
            <div className='grid grid-cols-5 gap-3'>
              {[
                ...
                <div
                  key={i}
                  className={`rounded-xl border-2 ${stat.color} bg-white p-4 text-center`}
                >
