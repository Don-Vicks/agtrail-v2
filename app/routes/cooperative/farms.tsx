...
import { cooperativeFarms, cooperativeDashboardStats } from '~/lib/mock-data/cooperative'
...
export default function CooperativeFarms() {
  ...
  const filteredFarms = cooperativeFarms.filter((farm) =>
  ...
  const activeFarms = cooperativeFarms.length
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-brand uppercase tracking-wide">ALL FARMS</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="rounded-md border border-gray-200 bg-white p-5">
          ...
          <p className="text-3xl font-bold text-brand">{cooperativeFarms.length}</p>
        </div>
        <div className="rounded-md border border-gray-200 bg-white p-5">
          <p className="text-sm text-gray-500 mb-1">Total Area</p>
          <p className="text-3xl font-bold text-brand">{cooperativeDashboardStats.totalArea} ha</p>
        </div>
        <div className="rounded-md border border-gray-200 bg-white p-5">
