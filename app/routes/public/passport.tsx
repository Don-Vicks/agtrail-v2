    ...
    <div className="min-h-screen bg-[#050f08] text-white font-sans selection:bg-[#10b981]/20 pb-20 flex flex-col items-center !overflow-x-hidden">
                  ...
                  {operations.map((op, i) => (
                    <div key={op.id ?? i} className="relative group">
                       ...
                       <div className="space-y-2.5">
                          ...
                          {(op.equipmentUsed?.length || op.personnelResponsible || op.weatherConditions) && (
                            <div className="rounded-md border border-white/5 bg-[#0e1f14] p-4 space-y-3 mt-2">
                               ...
                               <div className="grid grid-cols-1 gap-2">
                                  {op.personnelResponsible && <div className="flex items-center gap-4 text-[10px]"><span className="text-white/40 w-16">Operator:</span><span className="font-medium text-white/90">{op.personnelResponsible}</span></div>}
                          ...
                          <a 
                             href={(op as any).stellarTxHash ? `https://stellar.expert/explorer/testnet/tx/${(op as any).stellarTxHash}` : "https://stellar.expert/explorer/testnet/"}
                             target="_blank"
      ...
      <div className="fixed bottom-8 right-5 z-50 flex flex-col items-end gap-4">
         ...
         >
            ...
            {!isChatOpen && (
              <div className="absolute inset-0 bg-gradient-to-tr from-[#10b981]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            )}
         </button>
      </div>
