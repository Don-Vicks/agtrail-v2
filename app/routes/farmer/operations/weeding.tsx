  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <textarea rows={3} required placeholder="Describe the weeding operation... (e.g., Manual weeding of maize field)" className="w-full resize-none rounded-md border border-gray-200 px-3.5 py-2.5 text-sm placeholder:text-gray-400 focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/20" />
      </div>
    </OperationFormLayout>
  )
}
