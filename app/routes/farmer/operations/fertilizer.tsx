    ...
    >
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="text" placeholder="e.g., NPK 15-15-15, Urea, etc." className="w-full rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm placeholder:text-gray-400" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div>
          ...
          <input type="text" placeholder="e.g., 15-15-15" className="w-full rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm placeholder:text-gray-400" />
        ...
        <div>
          ...
          <input type="text" required placeholder="Enter quantity" className="w-full rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm placeholder:text-gray-400" />
        </div>
      </div>
      ...
      <div>
        ...
        <textarea rows={3} required placeholder="Describe the fertilizer application... (e.g., Applied NPK fertilizer to maize field)" className="w-full resize-none rounded-lg border border-gray-200 px-3.5 py-2.5 text-sm placeholder:text-gray-400 focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/20" />
      </div>
    </OperationFormLayout>
  )
}
