        ...
        <div className="p-5">
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-2xl font-bold tracking-tight text-[#2e7d32]">Adebayo Okonkwo</p>
                <p className="text-xl font-semibold tracking-tight text-[#2e7d32]">adebayo@ogunfarm.ng</p>
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <Button
              onClick={onRerun}
              className="h-10 bg-[#2e7d32] px-5 text-[10px] font-bold uppercase tracking-widest hover:bg-brand/90"
            >
              Re-scan
            </Button>
          </div>
                  ...
                  <tr key={row.id} className="border-b border-gray-50 last:border-0">
                    ...
                    <td className="px-3 py-3 text-right">
                      <Button
                        ...
                        className="h-8 bg-[#2e7d32] px-4 text-[10px] font-bold uppercase tracking-widest hover:bg-brand/90"
                      >
                        Scan
                      </Button>
                    </td>
