      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-8">
          <div className="rounded-[32px] border border-gray-100 bg-white p-8 shadow-sm">
            <div className="flex items-start justify-between mb-6">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex size-7 items-center justify-center rounded-lg border border-gray-100 text-gray-300">
            ...
            <div className="rounded-xl border border-gray-100 bg-white p-3.5 flex items-center gap-3">
              <div className="flex size-6 items-center justify-center rounded-lg border border-gray-100 text-gray-400">
                ...
                <div key={log.id} className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm relative overflow-hidden">
                  ...
                  {log.breached && (
                    <div className="flex gap-3">
                      <div className="flex flex-1 items-center gap-3 rounded-xl border border-[#2e7d32]/10 bg-[#e8f5e9]/30 px-4 py-3">
                      ...
                      <div className="flex flex-1 items-center gap-3 rounded-xl border border-gray-100 bg-white px-4 py-3">
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-[#1a4332] hover:bg-[#122e22] text-white rounded-lg h-9 px-4 text-[10px] font-bold uppercase tracking-widest gap-2">
          <Plus className="size-3.5" />
          New lot
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[480px] p-6 rounded-xl border-none shadow-2xl bg-white">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="space-y-1.5">
            ...
            <Input defaultValue="COC-2025-014" className="h-9 bg-gray-50/50 border-gray-200 rounded-lg text-xs" />
          </div>
          <div className="space-y-1.5">
            <Label className="text-[9px] font-bold text-[#2e7d32] uppercase tracking-widest">Commodity</Label>
            <Input placeholder="Cocoa beans" className="h-9 bg-white border-gray-200 rounded-lg text-xs" />
          </div>
          <div className="space-y-1.5">
            <Label className="text-[9px] font-bold text-[#2e7d32] uppercase tracking-widest">Quantity (Kg)</Label>
            <Input placeholder="" className="h-9 bg-white border-gray-200 rounded-lg text-xs" />
          </div>
          <div className="space-y-1.5">
            <Label className="text-[9px] font-bold text-[#2e7d32] uppercase tracking-widest">Origin</Label>
            <Input placeholder="Region, Country" className="h-9 bg-white border-gray-200 rounded-lg text-xs" />
          </div>
        </div>
        ...
        <div className="rounded-xl border border-gray-100 bg-white p-4 mb-6 flex items-center justify-between">
           <div>
        ...
        <div className="flex gap-3">
          <Button onClick={() => {}} variant="outline" className="h-10 flex-1 rounded-xl bg-[#dc2626] hover:bg-red-700 text-white border-none text-xs font-bold uppercase tracking-widest transition-all active:scale-95">
            Cancel
          </Button>
          <Button className="h-10 flex-1 rounded-xl bg-[#1a4332] hover:bg-[#122e22] text-white text-xs font-bold uppercase tracking-widest shadow-md shadow-[#1a4332]/10 transition-all active:scale-95">
            Create Lot
          </Button>
        </div>
      </DialogContent>
...
function LogConditionModal({ lotId }: { lotId: string }) {
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-[#1a4332] hover:bg-[#122e22] text-white rounded-lg h-8 px-4 text-[9px] font-bold uppercase tracking-widest gap-2">
          <Plus className="size-3" />
          Log entry
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[480px] p-6 rounded-xl border border-dashed border-[#2e7d32]/30 shadow-2xl bg-white">
        <DialogHeader className="mb-6">
        ...
        <div className="space-y-4 mb-6">
          <div className="space-y-1.5">
            ...
            <Input placeholder="e.g. Warehouse A - Bay 3" className="h-9 bg-white border-gray-200 rounded-lg text-xs" />
          </div>
          
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label className="text-[9px] font-bold text-[#2e7d32] uppercase tracking-widest">Date & Time</Label>
              <Input defaultValue="04/23/2026 04:12 pm" className="h-9 bg-white border-gray-200 rounded-lg text-xs" />
            </div>
            <div className="space-y-1.5">
              <Label className="text-[9px] font-bold text-[#2e7d32] uppercase tracking-widest">Temperature (c)</Label>
              <Input placeholder="e.g. 18.5" className="h-9 bg-white border-gray-200 rounded-lg text-xs" />
            </div>
          </div>

          <div className="space-y-1.5">
            <Label className="text-[9px] font-bold text-[#2e7d32] uppercase tracking-widest">Humidity</Label>
            <Input placeholder="e.g. 65%" className="h-9 bg-white border-gray-200 rounded-lg text-xs" />
          </div>

          <div className="space-y-1.5">
            <Label className="text-[9px] font-bold text-[#2e7d32] uppercase tracking-widest">Notes (optional)</Label>
            <textarea 
              className="w-full min-h-[100px] p-3 bg-white border border-gray-200 rounded-lg text-xs text-gray-600 focus:outline-none focus:ring-1 focus:ring-[#2e7d32]/20"
