      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <div className="h-11 flex items-center px-4 rounded-md bg-blue-50/50 border border-blue-100/50 text-brand font-bold text-sm">
                    LT-8829-XJ-2024
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input readOnly value="45.280" className="h-11 bg-blue-50/50 border-blue-100/50 rounded-md text-sm font-bold text-brand pr-24" />
              ...
              <div className="grid grid-cols-2 gap-8 pt-4 border-t border-dashed border-gray-100">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-11 bg-white border-gray-200 rounded-md text-sm font-bold pr-12"
                    />
                ...
                <div className="space-y-2">
                  ...
                  <Input placeholder="Enter quantity" className="h-11 bg-white border-gray-200 rounded-md text-sm font-bold" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input placeholder="WBR-####-####" className="h-11 bg-white border-gray-200 rounded-md text-sm font-bold pl-12" />
              ...
              <div className="flex items-center justify-end gap-3 pt-4">
                <Button variant="outline" className="h-11 px-8 rounded-md border-gray-200 text-gray-600 font-bold text-sm">
                  Save Draft
                </Button>
                <Button className="h-11 px-8 rounded-md bg-brand hover:bg-brand/90 text-white font-bold text-sm gap-2">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="rounded-md border border-gray-100 bg-white p-6 shadow-sm flex items-center gap-5">
              <div className="size-12 rounded-md bg-green-50 flex items-center justify-center text-brand border border-green-100/50">
        ...
        <div className="space-y-6">
          <div className="rounded-md border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 rounded-md bg-red-50 border border-red-100/50 flex items-start gap-3">
          ...
          <div className="rounded-md border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full py-4 rounded-md border-2 border-dashed border-gray-100 flex flex-col items-center justify-center gap-2 hover:bg-gray-50 transition-colors group">
...
function ManifestFile({ name, icon }: { name: string, icon: React.ReactNode }) {
  return (
    <div className="flex items-center justify-between p-3 rounded-md border border-gray-100 bg-white group hover:border-brand/20 transition-all">
