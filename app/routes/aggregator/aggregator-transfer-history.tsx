...
export default function AggregatorTransferHistory() {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-500 font-medium mt-1">Review all past product transfers from the aggregator.</p>
        </div>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                <tr className="hover:bg-gray-50/50 transition-colors">
                  <td className="px-6 py-4 font-medium text-gray-900">Oct 28, 2024</td>
                  <td className="px-6 py-4 font-mono text-xs text-brand font-bold">#BATCH-77665</td>
                  <td className="px-6 py-4 font-bold text-gray-900">Cocoa</td>
                  <td className="px-6 py-4 text-gray-500 font-medium">Export Warehouse</td>
                  <td className="px-6 py-4 font-bold text-gray-900">10,000 KG</td>
