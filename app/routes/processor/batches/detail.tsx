...
export default function BatchDetailsPage() {
  ...
  return (
    <div className="space-y-6 pb-10">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "p-3 rounded-md border text-left transition-all relative overflow-hidden",
      ...
      <div className="mt-8">
        ...
        {currentStep === 1 && (
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
            ...
            <div className="rounded-md border border-gray-200 bg-white p-16 shadow-sm flex flex-col items-center justify-center text-center">
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
            ...
            {/* Sub-Header Actions */}
            <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4">
              <div>
              ...
              <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-2">
                    ...
                    <select value={stepData.name || ''} onChange={e => setStepData({ ...stepData, name: e.target.value })} className="w-full h-10 px-3 rounded-md border border-gray-200 text-sm bg-gray-50/50 outline-none focus:border-brand focus:ring-1 focus:ring-brand">
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <textarea value={stepData.description || ''} onChange={e => setStepData({ ...stepData, description: e.target.value })} rows={3} placeholder="Detailed description of the processing step..." className="w-full rounded-md border border-gray-200 p-3 text-sm bg-gray-50/50 outline-none focus:border-brand focus:ring-1 focus:ring-brand resize-none" />
                  </div>
                  <div className="md:col-span-2 space-y-2">
                    <label className="text-[11px] font-bold uppercase tracking-widest text-gray-500">Notes</label>
                    <textarea value={stepData.notes || ''} onChange={e => setStepData({ ...stepData, notes: e.target.value })} rows={3} placeholder="Additional notes or observations..." className="w-full rounded-md border border-gray-200 p-3 text-sm bg-gray-50/50 outline-none focus:border-brand focus:ring-1 focus:ring-brand resize-none" />
                  </div>
                </div>
              ...
              <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="space-y-2">
                    ...
                    <select value={fortData.type || ''} onChange={e => setFortData({ ...fortData, type: e.target.value })} className="w-full h-10 px-3 rounded-md border border-gray-200 text-sm bg-gray-50/50 outline-none focus:border-brand">
                  ...
                  <div className="space-y-2">
                    ...
                    <select value={fortData.stage || ''} onChange={e => setFortData({ ...fortData, stage: e.target.value })} className="w-full h-10 px-3 rounded-md border border-gray-200 text-sm bg-gray-50/50 outline-none focus:border-brand">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <select value={fortData.unit || 'mg'} onChange={e => setFortData({ ...fortData, unit: e.target.value })} className="h-10 px-3 rounded-md border border-gray-200 text-sm bg-gray-50/50 outline-none focus:border-brand w-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <div className="w-full flex items-center gap-4 bg-gray-50/50 border border-gray-200 rounded-md h-11 px-3">
            ...
            <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4 mb-8">
                {processingStepsList.length === 0 ? (
                  ...
                  <div key={idx} className="rounded-md border border-gray-100 p-5 bg-gray-50/30">
              ...
              <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <select value={packData.type || ''} onChange={e => setPackData({ ...packData, type: e.target.value })} className="w-full h-10 px-3 rounded-md border border-gray-200 text-sm bg-gray-50/50 outline-none focus:border-brand">
                  ...
                  <div className="space-y-2">
                    ...
                    <select value={packData.rating || ''} onChange={e => setPackData({ ...packData, rating: e.target.value })} className="w-full h-10 px-3 rounded-md border border-gray-200 text-sm bg-gray-50/50 outline-none focus:border-brand">
                ...
                <div className="space-y-2 mb-8">
                  ...
                  <div className="border-2 border-dashed border-gray-200 rounded-md p-8 flex flex-col items-center justify-center text-center bg-gray-50/50 hover:bg-gray-50 transition-colors cursor-pointer">
            ...
            <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                {packagingList.length === 0 ? (
                  ...
                  <div key={idx} className="rounded-md border border-gray-100 p-5 bg-gray-50/30 flex justify-between items-start">
                    <div>
      ...
      <div className="mt-8 flex items-center justify-between border-t border-gray-200 pt-6 bg-white rounded-md p-4 shadow-sm">
        <Button
          variant="outline"
