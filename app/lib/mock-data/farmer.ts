...
export const products: Product[] = [
  {
    ...
    journey: [
      {
        title: 'Planting',
        description: 'We planted the seed gotten from Dangote ferterliser',
        date: 'October 7th, 2025',
        time: '23:29:41',
        details: [
          { label: 'Operator Name', value: 'Olamide Tunde' },
          { label: 'Supervisor Name', value: 'Olamide Tunde' },
          { label: 'Equipment Used', value: 'Hoes' },
          { label: 'Materials Used', value: '' }, // We use a special empty value to trigger header styling if needed, or we'll just handle it in the UI loop
          { label: '  SeedingRate', value: '15' },
          { label: '  PlantVariety', value: 'Maize Turbo' },
          { label: 'Area Covered', value: '0.02' },
          { label: 'Weather Conditions', value: 'Overcast' },
          { label: 'Cost', value: 'NGN 9.97' },
          { label: 'Onchain Record', value: '464e2f4c8823e0aeb6cd3b88f196c549c35dc69d23ba8a85c22b5d7693f10f37' },
        ],
      },
      {
        title: 'Land Preparation',
        description: 'We cleared the land to prepare for the planting season',
        date: 'October 7th, 2025',
        time: '23:28:09',
        details: [
          { label: 'Operator Name', value: 'Olamide Tunde' },
          { label: 'Supervisor Name', value: 'Olamide Tunde' },
          { label: 'Equipment Used', value: 'Hoes And Cultass' },
          { label: 'Area Covered', value: '0.02' },
          { label: 'Weather Conditions', value: 'Overcast' },
          { label: 'Cost', value: 'NGN 10' },
          { label: 'Onchain Record', value: '8ecf713fe33ddc8a13af17ca108102a5b86ec9c194b261f64d9dad87254b4bb2' },
        ],
      },
    ],
    tests: [
